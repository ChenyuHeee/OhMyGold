...
def _evaluate_liquidity(
    *,
    ...
    spread_p95_bps = _safe_float(liquidity_metrics.get("spread_bps_p95"))
    spread_avg_bps = _safe_float(liquidity_metrics.get("spread_bps_avg"))
    ...
    evaluated.update(
        {
            ...
            "liquidity_spread_p95_bps": spread_p95_bps,
            "liquidity_spread_avg_bps": spread_avg_bps,
        }
    )
    ...
    if spread_p95_bps is not None:
        spread_limit_base = max(spread_limit_base, float(spread_p95_bps))
